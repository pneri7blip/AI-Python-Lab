# Exercise 5: Specify the Steps to Complete a Task

## Objective
Give the model time to think by breaking a complex text-analysis task into clear, sequential steps. Defining a structured output format keeps responses consistent and easy to process in automated workflows.
> 
## Prompt Used
